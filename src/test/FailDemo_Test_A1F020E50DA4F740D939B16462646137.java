...
public class FailDemo_Test_A1F020E50DA4F740D939B16462646137 extends LTTestScript  {
...
pa.addPA("com.ibm.rational.test.lt.execution.moeb.dc.MoebDataAdapter", "com.ibm.rational.test.lt.execution.moeb.action.MoebStepBatchAction");
	...
	public FailDemo_Test_A1F020E50DA4F740D939B16462646137(IContainer container, String invocationId) {
		super(container, "failDemo", invocationId, "A1F020E50DA4F740D939B16462646137", "/DemoAltoroJTest/Tests/failDemo.testsuite", "/home/devsecop_demo/IBM/devopstest/workspace/DemoAltoroJTest/Tests/failDemo.testsuite");
		setArmEnabled(false);
...
this.addEventBehavior(new RPTEventStructure(new RPTFailVPEvent(), new RPTContinueEvent("Content Verification Point failed"), 1, "Content Verification Point failed"));
	...
	this.add(transaction_1(this));
			this.addFinally(new EndMoebStepBatchAction(this));
		     ...
		     log("Test Execution: FailDemo_Test_A1F020E50DA4F740D939B16462646137 ",e);
	    } finally {
	        super.execute();
		}	    
    }
	...
	VariableAction vc = new VariableAction(parent, "", "A1F020E50DA54570D939B16462646137");	
	...
	private ArmableTransaction transaction_1(final IContainer parent) {
		ArmableTransaction trx = new ArmableTransaction(parent, "faildemo", "A1F020E50DBBB390D939B16462646137") {
