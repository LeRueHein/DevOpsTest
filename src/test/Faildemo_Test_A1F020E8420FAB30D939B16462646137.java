...
public class Faildemo_Test_A1F020E8420FAB30D939B16462646137 extends LTTestScript  {
...
pa.addPA("com.ibm.rational.test.lt.execution.moeb.dc.MoebDataAdapter", "com.ibm.rational.test.lt.execution.moeb.action.MoebStepBatchAction");
	...
	public Faildemo_Test_A1F020E8420FAB30D939B16462646137(IContainer container, String invocationId) {
		super(container, "faildemo", invocationId, "A1F020E8420FAB30D939B16462646137", "/DemoAltoroJTest/TestsFail/faildemo.testsuite", "/home/devsecop_demo/IBM/devopstest/workspace/DemoAltoroJTest/TestsFail/faildemo.testsuite");
		setArmEnabled(false);
...
this.addEventBehavior(new RPTEventStructure(new RPTFailVPEvent(), new RPTContinueEvent("Content Verification Point failed"), 1, "Content Verification Point failed"));
	...
	this.add(applicationContext_1(this));
			this.addFinally(new EndMoebStepBatchAction(this));
		     ...
		     log("Test Execution: Faildemo_Test_A1F020E8420FAB30D939B16462646137 ",e);
	    } finally {
	        super.execute();
		}	    
    }
	...
	VariableAction vc = new VariableAction(parent, "", "A1F020E8420FD25DD939B16462646137");	
